...
function resizeCanvas(width, height, stylemult) {
  var canv = window.context;

  ctx.context.width  = width;
  ctx.context.height = height;
  if(stylemult) ctx.context.style = "width: " + (width * stylemult) + "px; height: " + (height * stylemult) + "px";
}

...
const DuckHunt: React.FC<DuckHuntProps> = ({ onBack }) => {
    const gameSrc = '/duckhunt/index.html';
    ...
    return (
        <div className="w-full max-w-6xl mx-auto space-y-4">
            <div className="bg-gradient-to-r from-blue-600 to-cyan-600 text-white md:p-6 p-3 border-2 border-cyan-400">
                <div className="text-center">
                    <div className="md:text-4xl text-2xl font-bold text-yellow-300">🦆 DUCK HUNT 🦆</div>
                    <div className="md:text-2xl text-xl font-bold text-white/90">Classic NES-style shooting fun</div>
                </div>
            </div>
                ...
                <div ref={containerRef} className="relative w-full" style={{ paddingTop: '56.25%' }}>
                    ...
                    {isLoading && (
                        <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/70 z-10" role="status" aria-live="polite">
                            ...
                            <div className="text-cyan-300 font-semibold">Loading Duck Hunt…</div>
                        </div>
                    )}
                    <iframe
                        title="Duck Hunt"
            ...
            <div className="bg-gradient-to-br from-yellow-500 to-orange-500 text-white border-2 border-yellow-400">
                <div className="p-4">
                    ...
                    <div className="text-sm space-y-1 mt-2 text-center">
                        <div>• Click/Tap to shoot ducks. Be quick and accurate!</div>
